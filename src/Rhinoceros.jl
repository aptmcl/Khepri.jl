...
rhino"public Entity Point(Point3d p)"
...
rhino"public Guid Ellipse(Point3d c, Vector3d n, double radius_x, double radius_y)"
...
rhino"public Entity SurfaceFromCurve(Entity curve)"
rhino"public Entity SurfaceCircle(Point3d c, Vector3d n, double r)"
rhino"public Entity SurfaceEllipse(Point3d c, Vector3d n, Vector3d majorAxis, double radiusRatio)"
rhino"public Entity SurfaceArc(Point3d c, Vector3d n, double radius, double startAngle, double endAngle)"
rhino"public Entity SurfaceClosedPolyLine(Point3d[] pts)"
=#
rhino"public Brep[] SurfaceFromCurves(RhinoObject[] objs)"
...
#
rhino"public void DeleteAll()"
rhino"public void DeleteAllInLayer(String name)"
